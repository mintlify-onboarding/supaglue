...
<Warning>Supaglue is in Public Alpha. There are currently many missing features, interfaces will likely change, and it is not production-ready yet.</Warning>
...
<CardGroup cols={2}>
  <Card title="Integration as code" icon="code" color="#7855FF">
    Use Typescript as declarative configuration to define syncs.
  </Card>
  <Card title="Managed syncs" icon="rotate" color="#7855FF">
    Let Supaglue execute syncs for you with fault-tolerance, retries, rate limiting, and error handling.
  </Card>
  <Card title="Managed OAuth" icon="list-check" color="#7855FF">
    Offload OAuth flows, storing & refreshing tokens to Supaglue
  </Card>
  <Card title="Embeddable UI components" icon="anchor" color="#7855FF">
    Customer-facing React components that let your customers configure syncs. Fully-functional and customizable.
  </Card>
  <Card title="Prebuilt sync templates" icon="palette" color="#7855FF">
     Use ready-made sync templates or customize them to your use case.
  </Card>
  <Card title="Open source" icon="shield-halved" color="#7855FF">
    Self-host Supaglue or extend it. Sensitive customer data never leaves your cloud.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Private Alpha" icon="square-check" color="#7855FF">
    Testing Supaglue with a closed set of developers
  </Card>
  <Card title="Public Alpha" icon="square-check" color="#7855FF">
    Anyone can run Supaglue locally using Docker. Go easy on us! We're working on substantial improvements.
  </Card>
  <Card title="Public Beta" icon="square" color="#7855FF">
    Stable and feature-rich enough to implement in production
  </Card>
  <Card title="Public" icon="square" color="#7855FF">
    Production-ready for majority of integration use cases with Salesforce
  </Card>
</CardGroup>
