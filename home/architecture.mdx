---
title: "Architecture"
description: "Integration as code for building full-stack integrations with your customers' SaaS platforms."
---
...
- **Config SDK** to author [sync configuration](/concepts) declaratively
- **CLI** to publish sync configuration changes
- **API** to communicate an coordinate with your application, Salesforce, and Supaglue
- **Workflow engine (Temporal)** to reliably execute [syncs](/concepts)
